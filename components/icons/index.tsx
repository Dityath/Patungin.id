...
export const AddAvatarIcon = (): JSX.Element => (
  <svg
    width="45"
    height="45"
    viewBox="0 0 45 45"
  ...
  >
    <path
      d="M22.5 3.21429C33.1071 3.21429 41.7857 11.8929 41.7857 22.5C41.7857 33.1071 33.1071 41.7857 22.5 41.7857C11.8929 41.7857 3.21429 33.1071 3.21429 22.5C3.21429 11.8929 11.8929 3.21429 22.5 3.21429ZM22.5 0C10.125 0 0 10.125 0 22.5C0 34.875 10.125 45 22.5 45C34.875 45 45 34.875 45 22.5C45 10.125 34.875 0 22.5 0Z"
      fill="#01204C"
    />
    <path
      d="M35.5263 20.8717H24.1282V9.47363H20.8717V20.8717H9.47363V24.1282H20.8717V35.5263H24.1282V24.1282H35.5263V20.8717Z"
      fill="#01204C"
    />
  </svg>
);
